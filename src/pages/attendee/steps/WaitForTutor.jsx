...
export default function WaitForTutor({ onNext }) {
  return (
    <div className="flex flex-col items-center text-center gap-6 py-8">
      <Scout size="lg" />

      <div className="flex flex-col gap-1">
        <h2 className="text-2xl font-bold text-navy-600">Great work!</h2>
        <p className="text-slate-500 text-sm">You've completed the opening confidence check.</p>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-2xl px-6 py-5 w-full max-w-xs">
        ...
        <p className="text-slate-500 text-sm">
          Your tutor will let you know when to move on to the next part.
        </p>
      </div>
