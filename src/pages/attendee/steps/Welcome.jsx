...
export default function Welcome({ onNext }) {
  return (
    <div className="flex flex-col items-center text-center gap-6 py-8">
      <Scout size="lg" />
      <div>
        <h1 className="text-2xl font-bold text-navy-DEFAULT mb-2">Hi, I'm Scout! 👋</h1>
      ...
      <button
        onClick={onNext}
        className="bg-teal-DEFAULT text-white px-8 py-3 rounded-xl font-semibold text-base hover:bg-teal-500 transition-colors shadow-sm"
      >
        Let's get started →
      </button>
    </div>
